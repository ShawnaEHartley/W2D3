...
describe "Board" do
  ...
  describe "PART 1" do
    describe "#initialize" do
      ...
      it "should set @size to be a number representing the total size of the 
      grid (n * n)" do
    ...
    describe "#[]" do
      it "should accept an array containing a pair of indices in the 
      form [row, column] representing a position on the @board" do
        pos = [2, 4]
        board[pos]
      end
  ...
  describe "PART 2" do
    ...
    describe "#place_random_ships" do
      ...
      it "should always set 25% of the @grid's elements based on the @grid's 
      dimensions" do
    ...
    describe "#hidden_ships_grid" do
      it "should return a 2D array representing the grid where every :S is 
      replaced with an :N" do
        board = Board.new(2)
